...
subagent: true
maxTurns: 30
tools: ["Read", "Glob", "Grep", "TodoWrite", "mcp__plugin_arckit_microsoft-learn__microsoft_docs_search", "mcp__plugin_arckit_microsoft-learn__microsoft_docs_fetch", "mcp__plugin_arckit_microsoft-learn__microsoft_code_sample_search"]
effort: high
description: |
  Reader subagent invoked by /arckit:azure-research (orchestrator).
  Queries the Microsoft Learn MCP for one research category and extracts
  factual evidence about Azure services, including region
