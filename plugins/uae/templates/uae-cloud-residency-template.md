...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uae:uae-cloud-residency`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-uae:uae-cloud-residency` | [PENDING] | [PENDING] |
...
**Generated by**: ArcKit `/arckit-uae:uae-cloud-residency` command
**Generated on**: [DATE]
