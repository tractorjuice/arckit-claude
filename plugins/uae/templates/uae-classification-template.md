...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uae:uae-classification`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-uae:uae-classification` | [PENDING] | [PENDING] |
...
**Generated by**: ArcKit `/arckit-uae:uae-classification` command
**Generated on**: [DATE]
