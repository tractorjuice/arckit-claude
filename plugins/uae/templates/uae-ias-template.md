...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uae:uae-ias`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-uae:uae-ias` | [PENDING] | [PENDING] |
...
**Generated by**: ArcKit `/arckit-uae:uae-ias` command
**Generated on**: [DATE]
