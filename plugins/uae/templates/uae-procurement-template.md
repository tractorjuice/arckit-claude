...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uae:uae-procurement`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-uae:uae-procurement` | [PENDING] | [PENDING] |
...
**Generated by**: ArcKit `/arckit-uae:uae-procurement` command
**Generated on**: [DATE]
