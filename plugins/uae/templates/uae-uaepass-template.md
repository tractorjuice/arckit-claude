...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uae:uae-uaepass`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-uae:uae-uaepass` | [PENDING] | [PENDING] |
...
**Generated by**: ArcKit `/arckit-uae:uae-uaepass` command
**Generated on**: [DATE]
