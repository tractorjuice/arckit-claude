...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/arckit-agent-architecture:agent-integration` command |
```

### Generation Metadata Footer

```markdown
**Generated by**: ArcKit `/arckit-agent-architecture:agent-integration` command
**Generated on**: {DATE}
...
User: `/arckit-agent-architecture:agent-integration Design integration for the research swarm in project 003`
...
- **Output**: Feeds into `/arckit-agent-architecture:agent-governance` (governance for multi-agent orchestration)
- **Output**: Feeds into `/arckit-agent-architecture:agent-security` (securing inter-agent communication)
- **Output**: Feeds into `/arckit-agent-architecture:agent-maturity` (maturity assessment of integration capabilities)
...
- Run `/arckit-agent-architecture:agent-governance` to apply governance to multi-agent orchestration
- Run `/arckit-agent-architecture:agent-security` to secure inter-agent communication
```
