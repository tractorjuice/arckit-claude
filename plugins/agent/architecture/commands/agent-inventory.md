...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/arckit-agent-architecture:agent-inventory` command |
```

### Generation Metadata Footer

```markdown
**Generated by**: ArcKit `/arckit-agent-architecture:agent-inventory` command
**Generated on**: {DATE}
...
- Suggested next steps (e.g., "Run `/arckit-agent-architecture:agent-security` to assess security posture" or "Run `/arckit-agent-architecture:agent-design` for new agent architecture")

## Example Usage

User: `/arckit-agent-architecture:agent-inventory Catalog all AI agents in the data processing pipeline`
...
- **Output**: Feeds into `/arckit-agent-architecture:agent-design` (architecture for new or modified agents based on inventory gaps)
- **Output**: Feeds into `/arckit-agent-architecture:agent-security` (security assessment for each inventoried agent)
- **Output**: Feeds into `/arckit-agent-architecture:agent-governance` (oversight framework built on inventory)
- **Output**: Feeds into `/arckit-agent-architecture:agent-integration` (integration patterns between inventoried agents)
- **Output**: Feeds into `/arckit-agent-architecture:agent-maturity` (maturity assessment across all agents)
...
- Run `/arckit-agent-architecture:agent-security` to assess security posture for inventoried agents
- Run `/arckit-agent-architecture:agent-design` to design architecture for new or modified agents
- Run `/arckit-agent-architecture:agent-governance` to establish oversight frameworks
```
