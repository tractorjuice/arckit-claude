...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-us:us-ai-rmf`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-us:us-ai-rmf` command | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit-us:us-ai-rmf` command
**Generated on**: [DATE]
