...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-us:us-icam`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-us:us-icam` command | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit-us:us-icam` command
**Generated on**: [DATE]
