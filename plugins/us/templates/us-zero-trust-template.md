...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-us:us-zero-trust`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-us:us-zero-trust` command | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit-us:us-zero-trust` command
**Generated on**: [DATE]
