...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-us:us-ai-impact`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-us:us-ai-impact` command | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit-us:us-ai-impact` command
**Generated on**: [DATE]
