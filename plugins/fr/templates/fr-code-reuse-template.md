...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-fr:fr-code-reuse`
>
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-fr:fr-code-reuse` | [PENDING] | [PENDING] |
...
**Generated by**: ArcKit `/arckit-fr:fr-code-reuse` command
