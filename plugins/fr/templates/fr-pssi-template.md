...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-fr:fr-pssi`
>
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-fr:fr-pssi` | [PENDING] | [PENDING] |
...
**Generated by**: ArcKit `/arckit-fr:fr-pssi` command
