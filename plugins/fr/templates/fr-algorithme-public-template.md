...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-fr:fr-algorithme-public`
>
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-fr:fr-algorithme-public` | [PENDING] | [PENDING] |
...
| Recommendation | [Run `/arckit-eu:eu-ai-act` for full AI Act assessment] |
...
**Generated by**: ArcKit `/arckit-fr:fr-algorithme-public` command
