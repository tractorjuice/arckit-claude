...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-au:au-dss`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-au:au-dss` command | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit-au:au-dss` command
**Generated on**: [DATE]
