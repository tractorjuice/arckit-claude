...
Next steps:
1. {If NIS2 overlap: Run /arckit-eu:eu-nis2}
2. {If AI component: Run /arckit-eu:eu-ai-act}
...
```text
/arckit-eu:eu-cra Assess CRA compliance for an industrial IoT gateway device placed on EU market, connecting factory floor OT equipment to cloud analytics, firmware updateable, classified as Important (Class I) under Annex III

/arckit-eu:eu-cra CRA assessment for 001 — password manager software (SaaS), placed on EU market, subscription model, Class I classification expected

/arckit-eu:eu-cra CRA compliance for an open source network monitoring tool with commercial support contract, assess whether the open source steward exemption applies
```
