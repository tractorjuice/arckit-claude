...
Next steps:
1. {If personal data in recommender/ads: Run /arckit-eu:eu-rgpd}
2. {If AI-driven moderation or recommendation: Run /arckit-eu:eu-ai-act}
...
- **Recommender systems and AI Act overlap**: Recommender systems may simultaneously fall under DSA (transparency) and AI Act (high-risk if employment/benefits context). Run `/arckit-eu:eu-ai-act` if AI-driven.
...
```text
/arckit-eu:eu-dsa Assess DSA compliance for a French online marketplace (€500M GMV, 8M monthly EU users), hosting third-party seller listings, with recommendation engine and targeted advertising

/arckit-eu:eu-dsa DSA scoping for 001 — social media platform with 60M monthly EU users, Commission designated VLOP, annual systemic risk assessment required

/arckit-eu:eu-dsa DSA compliance for a SaaS hosting service storing user-generated content for B2B clients, no public dissemination — assess hosting obligations
```
