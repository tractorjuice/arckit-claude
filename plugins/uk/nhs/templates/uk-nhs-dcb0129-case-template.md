...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uk-nhs:uk-nhs-dcb0129` | **Filename**: `SAFETY-CASE.md` (DCB0129 manufacturer case)
...
|---|---|---|---|---|---|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-uk-nhs:uk-nhs-dcb0129` command | PENDING | PENDING |
...
[State the product's clinical purpose, indications, contraindications, intended user population (specific clinical roles, patient populations), and intended clinical context. Be precise — the intended-use statement is load-bearing for medical-device classification (`/arckit-uk-nhs:uk-mdr-classification`) and for clinical-safety scope.]
...
**Generated by**: ArcKit `/arckit-uk-nhs:uk-nhs-dcb0129` command
