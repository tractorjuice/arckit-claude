...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uk-nhs:uk-mdr-classification`
...
|---|---|---|---|---|---|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-uk-nhs:uk-mdr-classification` command | PENDING | PENDING |
...
> The MHRA AIaMD Programme is publishing work packages incrementally. Re-run `/arckit-uk-nhs:uk-mdr-classification` when material MHRA updates are published. UK MDR reform is in train — verify the legal text against legislation.gov.uk before reliance.
...
**Generated by**: ArcKit `/arckit-uk-nhs:uk-mdr-classification` command
