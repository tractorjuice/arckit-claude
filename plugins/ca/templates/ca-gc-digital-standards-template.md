...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-ca:ca-gc-digital-standards`
...
| Remediation actions | [actions to close gaps — referencing the *Accessible Canada Act* statutory floor] |
...
|-------|-------------------|--------|--------|
| Accessibility (WCAG 2.1 AA / 2.2 AA, *Accessible Canada Act*) | 6 | [Conformant / Partial / Non-conformant] | [audit close-out, statutory plan refresh] |
...
| Update Accessibility Plan / progress report under the *Accessible Canada Act* | [Accessibility lead] | [YYYY-MM-DD] | [Open / Closed] |
