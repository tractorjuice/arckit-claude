...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-ca:ca-cloud-residency`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-ca:ca-cloud-residency` | [PENDING] | [PENDING] |
